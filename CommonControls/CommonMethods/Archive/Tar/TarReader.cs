...
namespace CommonControls.CommonMethods.Archive.Tar
{
    ...
    public class TarReader
    {
        ...
        {
            ReadToEnd(destDirectory,"");
        }
        public void ReadToEnd(string destDirectory, string codePage)
        {
            while (MoveNext(false))
            {
                ...
                {
                    directory = MyEncoding.c_encoding.DecodeCodePage(directory, codePage);
                    totalPath = MyEncoding.c_encoding.DecodeCodePage(totalPath, codePage);
                }
