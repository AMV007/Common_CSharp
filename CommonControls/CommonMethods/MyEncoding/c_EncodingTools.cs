...
{
    public static class c_EncodingTools
    {
        ...
        /// <summary>
        /// Gets the best System.Text.Encoding for usage in mime encodings
        /// </summary>
        /// <param name="input">text to detect</param>
        /// <returns>the suggested encoding</returns>
        public static System.Text.Encoding GetMostEfficientEncoding(string input)
        {
            return GetMostEfficientEncoding(input, PreferedEncodings);
        }

        /// <summary>
        /// Gets the best ISO System.Text.Encoding for usage in a stream
        /// </summary>
        /// <param name="input">text to detect</param>
        /// <returns>the suggested encoding</returns>
        public static System.Text.Encoding GetMostEfficientEncodingForStream(string input)
        {
        ...
        /// <returns>the suggested encoding</returns>
        public static System.Text.Encoding GetMostEfficientEncoding(string input, int[] preferedEncodings)
        {
            System.Text.Encoding enc = DetectOutgoingEncoding(input,preferedEncodings,true);
            // unicode.. hmmm... check for smallest encoding
            if (enc.CodePage == System.Text.Encoding.Unicode.CodePage)
            {
                int byteCount = System.Text.Encoding.UTF7.GetByteCount(input);
                ...
                // unicode smaller?
                byteCount = System.Text.Encoding.Unicode.GetByteCount(input);
                if (byteCount < bestByteCount)
                {
        ...
        public static System.Text.Encoding DetectOutgoingEncoding(string input)
        {
            return DetectOutgoingEncoding(input, PreferedEncodings, true);
        }

        public static System.Text.Encoding DetectOutgoingStreamEncoding(string input)
        {
            return DetectOutgoingEncoding(input, PreferedEncodingsForStream, true);
        }

        public static System.Text.Encoding[] DetectOutgoingEncodings(string input)
        {
            return DetectOutgoingEncodings(input, PreferedEncodings, true);
        }

        public static System.Text.Encoding[] DetectOutgoingStreamEncodings(string input)
        {
            return DetectOutgoingEncodings(input, PreferedEncodingsForStream, true);
        }

        private static System.Text.Encoding DetectOutgoingEncoding(string input, int[] preferedEncodings, bool preserveOrder)
        {
            ...
            try
            {
                int[] resultCodePages = new int[preferedEncodings != null ? preferedEncodings.Length : System.Text.Encoding.GetEncodings().Length];
                ...
                try
                {
                    ...
                    if (detectedCodepages > 0)
                    {
                        ...
                        result = System.Text.Encoding.GetEncoding(theResult[0]);
                    }
        ...
        public static System.Text.Encoding[] DetectOutgoingEncodings(string input, int[] preferedEncodings, bool preserveOrder)
        {
            ...
            // empty strings can always be encoded as ASCII
            if (input.Length == 0)
                return new System.Text.Encoding[] { System.Text.Encoding.ASCII };

            List<System.Text.Encoding> result = new List<System.Text.Encoding>();
                ...
                try
                {
                    ...
                    if (detectedCodepages > 0)
                    {
                        ...
                        for (int i = 0; i < detectedCodepages; i++)
                            result.Add(System.Text.Encoding.GetEncoding(theResult[i]));
        ...
        public static System.Text.Encoding DetectInputCodepage(byte[] input)
        {
            try
            {
                System.Text.Encoding[] detected = DetectInputCodepages(input, 1);
        ...
        /// <returns>an array of System.Text.Encoding with assumed encodings</returns>
        public static System.Text.Encoding[] DetectInputCodepages(byte[] input, int maxEncodings)
        {
            ...
            try
            {
                ...
                if (scores > 0)
                {
                    ...
                    {
                        // add the result
                        result.Add(System.Text.Encoding.GetEncoding((int)detectedEncdings[i].nCodePage));
                    }
                }
            }
            finally
        ...
        public static string ReadTextFile(string path)
        {
            ...
            using (Stream fs = File.Open(path, FileMode.Open))
            {
                ...
                System.Text.Encoding enc = DetectInputCodepage(rawData);
        ...
        public static StreamReader OpenTextStream(Stream stream)
        {
            ...
            System.Text.Encoding detectedEncoding = System.Text.Encoding.Default;
